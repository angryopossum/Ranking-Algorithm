...
def new_rating (user_1,user_2,score,rating_1,rating_2)
 ...
 @rating_1[@user_1][0] = @rating_1[@user_1][0] + calculate(@user_2,@score,@rating_2)

return @rating_1
 
end

def calculate (user,score,rating)
